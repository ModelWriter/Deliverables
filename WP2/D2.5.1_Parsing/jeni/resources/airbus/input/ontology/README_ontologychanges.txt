...
We made several changes to the initial ontology provided by Airbus as it was an inconsistent ontology, and it contained unsatisfiable classes.
...
2. Remove two EquivalentClasses axioms:
...
[The next axiom caused unsatisfiability. To identify it, we had to add an individual to "http://airbus-group.installsys/component#Routing" class.]
4. Remove one Disjoint Classes axiom:
DisjointClasses(<http://airbus-group.installsys/component#PhysicalComponent> <http://airbus-group.installsys/component#VirtualComponent>)
