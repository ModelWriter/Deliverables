...
declare ?Idx ?Object 
{
        ?Object=CanObject[] ; ?Idx = ?Object.?ObjIdx    % this does re-exporting, is that necessary?
        %| WhObject[] 
        %| RelativeOvertObject[] 
...
declare ?Idx ?Subject
{
        ?Subject=CanByAgent[] ; ?Idx = ?Subject.?SubjIdx
        %| WhByAgent[] 
        %| WhAgentBy[] 
...
declare ?Idx ?Compl
{
        ?Compl=CanBEComplement[] ; ?Idx = ?Compl.?ComplIdx
        %| WhObject[] 
        %| RelativeOvertObject[] 
        %| RelativeCovertObject[] 
}
