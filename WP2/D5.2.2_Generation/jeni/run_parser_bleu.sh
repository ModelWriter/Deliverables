...
all_inputs_dir=""
configName="$@"
if [ "$configName" = "parse_airbus_excellex_colbc_sentence" ]
then
	all_inputs_dir="resources/airbus/output/airbus_parse_output/excellex_colbc_sentences/BLUE_Files/"
elif [ "$configName" = "parse_airbus_excellex_true_sentence" ]
then
	all_inputs_dir="resources/airbus/output/airbus_parse_output/excellex_true_sentences/BLUE_Files/"
#elif [ "$configName" = "" ]
#then
else
